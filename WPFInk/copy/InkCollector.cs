...
namespace WPFInk.ink
{
    ...
    public class InkCollector
    {
        ...
        private void loadKeyFrames(string videoName)
        {
            ...
            {
                KeyFrame keyFrame = new KeyFrame(GlobalValues.FilesPath + "/" + videoName + ".avi", @"resource\" + videoName + @"\" + j + ".png", videoTimeList[j - 1]);
            ...
            for (int j = 1; j <= videoTimeList.Count; j++)
            {
                KeyFrame keyFrame = new KeyFrame(GlobalValues.FilesPath + "/" + videoName + ".avi", @"resource\" + videoName + @"_source\" + j + ".png", videoTimeList[j - 1]);
